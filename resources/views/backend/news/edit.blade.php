                ...
                <div class="box box-primary">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="textarea" id="editor1" name="details" placeholder="Place some text here"
                                style="width: 100%; height: 1010px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
                                    {{ $news->details }}
                                </textarea>
                        </div>
                    </div>
