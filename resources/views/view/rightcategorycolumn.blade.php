	              ...
	              <form action="{{ route('page.search') }}" method="GET"
                    ...
                    <div class="sidebar-box ftco-animate">
                        ...
                        @foreach($categories as $category)
                            <li>
                                <a href="{{url('/page/category/'.$category->slug)}}">{{ $category->name }} 
                    ...
                    <div class="sidebar-box ftco-animate">
                        ...
                        <div class="block-21 mb-4 d-flex">
                            <a href="{{ url('page/news/'.$topnews->slug) }}" class="blog-img mr-4" style="background-image: url({{ asset('images/'.$topnews->image) }});"></a>
                            <div class="text">
                                <h3 class="heading"><a href="{{ url('page/news/'.$topnews->slug) }}">{{ str_limit(strip_tags($topnews->title), 50)}}</a></h3>
                                <div class="meta">
                    ...
                    <div class="sidebar-box ftco-animate">
                        ...
                        <ul class="tagcloud">
                            ...
                            @foreach(explode(',',$tags) as $tag)
                                <a href="{{url('/page/search') . '?search=' .urlencode('#' . $tag)}}">{{ $tag }} 
                                </a>                            
                            @endforeach
                        </ul>
                    </div>
